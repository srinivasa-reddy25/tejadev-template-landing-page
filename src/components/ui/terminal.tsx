...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        'border-border bg-card z-0 h-full w-full rounded-2xl border overflow-hidden',
        className
      )}
    >
      <div className="border-border flex items-center gap-x-2 border-b px-4 py-3 bg-muted/40">
        <div className="h-3 w-3 rounded-full bg-destructive/70" />
        <div className="h-3 w-3 rounded-full bg-accent/50" />
        <div className="h-3 w-3 rounded-full bg-primary/60" />
      </div>
      <pre className="p-5 overflow-auto">
